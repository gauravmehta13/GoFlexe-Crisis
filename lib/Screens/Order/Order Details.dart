...
class _OrderDetailsState extends State<OrderDetails> {
  void initState() {
    super.initState();
    print(widget.details["trackingData"]);
    if (widget.details["trackingData"] != null) {
      getCurrentStage(widget.details["trackingData"]["stages"]);
    }

    orderId.text = widget.details["OrderId"];
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Order ${widget.details["progress"]}",
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 16,
                    ...
                    review == false
                        ? MaterialButton(
                            materialTapTargetSize:
                                MaterialTapTargetSize.shrinkWrap,
                            minWidth: 0,
                            onPressed: widget.details["trackingData"] == null
                                ? null
                                : () {
