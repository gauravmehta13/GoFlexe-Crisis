...
import 'package:crisis/data/Faq%20data.dart';
import 'package:crisis/data/Mythbuster%20data.dart';
import 'package:crisis/model/covid%20model.dart';
...
class _MythBustersState extends State<MythBusters> {
  List<MythBusterModel> filteredMyth = [];
